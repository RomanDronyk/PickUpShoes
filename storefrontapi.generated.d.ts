...
export type FooterQueryVariables = StorefrontAPI.Exact<{
  ...
  secondMenuHandle: StorefrontAPI.Scalars['String']['input'];
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
...
export type HomeHeroQuery = {
  collection?: StorefrontAPI.Maybe<{
    ...
    >;
    motto?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  }>;
};
    ...
    products: {
      filters: Array<
        Pick<StorefrontAPI.Filter, 'id' | 'label' | 'type'> & {
          values: Array<
            Pick<StorefrontAPI.FilterValue, 'id' | 'label' | 'input' | 'count'>
          >;
        }
      >;
    };
    ...
    nodes: Array<
      {__typename: 'MediaImage'} & Pick<StorefrontAPI.MediaImage, 'id'> & {
          previewImage?: StorefrontAPI.Maybe<
            Pick<StorefrontAPI.Image, 'url' | 'id' | 'height' | 'width'>
          >;
          image?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Image, 'url'>>;
        }
    >;
...
export type ViewedProductsQueryVariables = StorefrontAPI.Exact<{
  ids:
    | Array<StorefrontAPI.Scalars['ID']['input']>
    | StorefrontAPI.Scalars['ID']['input'];
}>;

export type ViewedProductsQuery = {
  nodes: Array<
    StorefrontAPI.Maybe<
      Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
        featuredImage?: StorefrontAPI.Maybe<
...
export type RecomendedProductsQueryVariables = StorefrontAPI.Exact<{
  id: StorefrontAPI.Scalars['ID']['input'];
}>;

export type RecomendedProductsQuery = {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query ViewedProducts(\n    $ids: [ID!]!\n  ) {\n nodes(ids: $ids) {\n    ... on Product {\n      id\n      title\n      handle\n      featuredImage {\n        id\n        altText\n        url\n        width\n        height\n      }\n      options {\n        name\n        values\n      }\n      priceRange {\n        minVariantPrice {\n          amount\n          currencyCode\n        }\n      }\n      variants(first:1){\n        nodes{\n          selectedOptions{\n            name\n            value\n          }\n          price{\n            amount\n            currencyCode\n          }\n          compareAtPrice{\n            amount\n            currencyCode\n          }\n        }\n      }\n    }\n    }\n  }\n': {
    return: ViewedProductsQuery;
    variables: ViewedProductsQueryVariables;
  };
  '#graphql\n  query RecomendedProducts($id: ID!){\n    productRecommendations(productId: $id){\n     ... on Product {\n      id\n      title\n      handle\n      featuredImage {\n        id\n        altText\n        url\n        width\n        height\n      }\n      options {\n        name\n        values\n      }\n      priceRange {\n        minVariantPrice {\n          amount\n          currencyCode\n        }\n      }\n      variants(first:1){\n        nodes{\n          selectedOptions{\n            name\n            value\n          }\n          price{\n            amount\n            currencyCode\n          }\n          compareAtPrice{\n            amount\n            currencyCode\n          }\n        }\n      }\n    } \n\n    }\n  }\n': {
    return: RecomendedProductsQuery;
    variables: RecomendedProductsQueryVariables;
  };
