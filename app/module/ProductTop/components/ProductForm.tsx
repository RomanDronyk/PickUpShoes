...
const ProductForm: FC<IProductForm> = ({
  ...
  const valueCheckedAllVarians = variants.every(variant => variant.availableForSale === false) ? "Немає в наявності" : null
  const valueCheckedVarian = selectedVariant?.availableForSale ? 'Додати в корзину' : 'Оберіть розмір'
  return (
