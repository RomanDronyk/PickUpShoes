export default function ThanksScreen() {
  return (
    <div className="flex flex-col contaier  md:grid  lg:grid-cols-[1fr_1fr]  w-full h-[90vh]  overflow-hidden"
    >
      ...
      <div className="bg-transparent rounded-[16px] shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-[9.6px] absolute inset-0"></div>
        <div className=' -scale-x-[1]  lg:items-start items-center flex flex-col py-[10vh] z-20  text-white m-[auto_auto]' >
