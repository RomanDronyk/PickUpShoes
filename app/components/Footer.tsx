       ...
       className="flex md:grid justify-between lg:px-24  px-5 sm:px-12 lg:flex-row flex-col sm:grid sm:grid-cols-2  sm:gap-y-[30px] gap-x-[20px] gap-y-[45px]">
        <div className="flex flex-col gap-4">
          ...
          <div className='pl-[13px] pt-[9px] flex gap-[10px]'>
            ...
            <a href='https://www.facebook.com/pick.up.shoes.ua' target='blank' className='animation-foter-link' style={{ borderRadius: "50%", border: "1px solid #fff", width: 28, height: 28, display: "flex", justifyContent: "center", alignItems: "center", }}>

              <span className="animation_show">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="14" cy="14" r="13.5" fill="black" stroke="white" />
                  <path d="M19.125 10.125L7.25 14.8125L11.625 15.4375M19.125 10.125L17.5625 19.5L11.625 15.4375M19.125 10.125L11.625 15.4375M11.625 15.4375V18.875L13.6556 16.8269" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </span>
              <span className="animation_hide">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="14" cy="14" r="14" fill="white" />
                  <circle cx="14" cy="14" r="13.5" stroke="black" strokeOpacity="0.2" />
                  <path d="M19.125 10.125L7.25 14.8125L11.625 15.4375M19.125 10.125L17.5625 19.5L11.625 15.4375M19.125 10.125L11.625 15.4375M11.625 15.4375V18.875L13.6556 16.8269" stroke="black" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            ...
            <a href='https://www.youtube.com/channel/UCLIOA-vH--WVwd2_ol2usZA/videos' target='blank' className='animation-foter-link' style={{ borderRadius: "50%", width: 28, height: 28, display: "flex", justifyContent: "center", alignItems: "center", }}>

              <span className="animation_show">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="14" cy="14" r="13.5" fill="black" stroke="white" />
                  <mask id="mask0_877_869" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="8" y="9" width="12" height="10">
                    <path d="M13.94 10C18.88 10 18.88 10 18.88 13.8422C18.88 17.6844 18.88 17.6844 13.94 17.6844C9 17.6844 9 17.6844 9 13.8422C9 10 9 10 13.94 10Z" fill="white" stroke="white" strokeWidth="2" strokeLinecap="round" />
                    <path d="M12.8422 11.9211L16.1355 13.8423L12.8422 15.7634V11.9211Z" fill="black" />
                  </mask>
                  <g mask="url(#mask0_877_869)">
                    <path d="M20.5267 7.25562H7.35333V20.4289H20.5267V7.25562Z" fill="white" />
                  </g>
                </svg>
              </span>
              <span className="animation_hide">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="14" cy="14" r="14" fill="white" />
                  <circle cx="14" cy="14" r="13.5" stroke="black" strokeOpacity="0.2" />
                  <mask id="mask0_877_4922" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="8" y="9" width="12" height="10">
                    <path d="M13.94 10C18.88 10 18.88 10 18.88 13.8422C18.88 17.6844 18.88 17.6844 13.94 17.6844C9 17.6844 9 17.6844 9 13.8422C9 10 9 10 13.94 10Z" fill="white" stroke="white" strokeWidth="2" strokeLinecap="round" />
                    <path d="M12.8422 11.9211L16.1355 13.8423L12.8422 15.7634V11.9211Z" fill="black" />
                  </mask>
                  <g mask="url(#mask0_877_4922)">
                    <path d="M20.5267 7.25562H7.35333V20.4289H20.5267V7.25562Z" fill="black" />
                  </g>
                </svg>
