...
export function LikedCart({product}: ILikedCart) {
  ...
  const {setCartShow, handleLikeToggle, setCartShowMobile} = useContext(
    HeaderBasketContext,
      ...
      <div className="flex flex-col min-h-[100px] relative  justify-center  register rounded-[20px] border border-black/10 p-6 my-[10px] mb-[30px] lg:mb-0">
        ...
        >
          ...
          >
              ...
              {(fetcher: FetcherWithComponents<any>) => (
                <>
                  ...
                  <button
                    type="submit"
                    disabled={
                      product.inventoryQuantity == 0 || fetcher.state !== 'idle'
                    }
                    className={cn(
            ...
            <button
              onClick={() => handleLikeToggle(product.id, 'delete')}
              style={{
                top: 0,
                right: 0,
                position: 'absolute',
